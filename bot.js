...
client.on('ready',  () => {
  console.log('By : Va | NoHaxJustAbdou  ');
...
القسم الثالث مصمم البوت | @Va | NoHaxJustAbdou [DZ$HOP]#6562 
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ●
...
if (message.content === '#support') {
      message.author.send(' |https://discord.gg/X6jZXWt| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '#invite') {
      message.author.send(' رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=549848185686720523&permissions=8&scope=bot ').catch(e => console.log(e.stack));
...
client.on('message', message => {
 ...
 const gamestats = [`#help `,`ProBot ✨`,`by Va | NoHaxJustAbdou `,`#support
 #invite
 `]
